 ...
 * @param n Number of jobs to return per page. Default is 50. Max is 1000.
 * @param cursor Pass this in from a previous query to paginate results.
 * @return *JobsWrapper
 */
func (a JobsApi) GroupsNameJobsGet(name string, createdAfter time.Time, n int32, cursor string) (*JobsWrapper, *APIResponse, error) {
